    ...
    >
      ...
      <div className="absolute inset-0 z-0 select-none overflow-hidden">
        ...
        <motion.div
          ...
          className="w-full h-full filter contrast-[105%] brightness-[80%] bg-center bg-cover"
      ...
      <div className="relative z-20 max-w-4xl mx-auto text-center flex flex-col items-center">
        ...
        <motion.h1
          ...
          className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-serif font-bold text-text-primary tracking-tight leading-[1.08] mb-6 text-subtle-float"
        >
          Premium Men&apos;s
          <span className="block mt-2 text-transparent bg-clip-text bg-gradient-to-r from-bronze via-[#F5E6D8] to-bronze font-serif italic font-normal text-shimmer">
            Grooming Excellence
          </span>
        </motion.h1>
        ...
        <motion.p
          ...
          className="max-w-xl md:max-w-2xl text-text-muted font-sans text-sm md:text-base leading-relaxed tracking-wide font-light mb-12 border-t border-white/[0.05] pt-6 subtle-tracking"
        >
